...
class QuestionClassifier:
    def __init__(self):
        ...
        self.disease_path = os.path.join(cur_dir, CONFIG.path.classifier.disease)
        self.department_path = os.path.join(cur_dir, CONFIG.path.classifier.department)
        self.check_path = os.path.join(cur_dir, CONFIG.path.classifier.check)
        self.drug_path = os.path.join(cur_dir, CONFIG.path.classifier.drug)
        self.food_path = os.path.join(cur_dir, CONFIG.path.classifier.food)
        self.producer_path = os.path.join(cur_dir, CONFIG.path.classifier.producer)
        self.symptom_path = os.path.join(cur_dir, CONFIG.path.classifier.symptom)
        self.deny_path = os.path.join(cur_dir, CONFIG.path.classifier.deny)
